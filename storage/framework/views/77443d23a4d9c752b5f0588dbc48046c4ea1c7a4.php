                        ...
                        <ul>
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="<?php echo e(asset('back-end')); ?>/img/%21sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="<?php echo e(asset('back-end')); ?>/img/%21sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="<?php echo e(asset('back-end')); ?>/img/%21sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
                                    </figure>
