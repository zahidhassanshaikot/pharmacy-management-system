    ...
    <header class="page-header page-header-left-breadcrumb">
        <div class="right-wrapper">
            <ol class="breadcrumbs">
                ...
                <li><span>Left Sidebar Panel Light</span></li>
            </ol>
    
            {{-- <a class="sidebar-right-toggle" data-open="sidebar-right"><i class="fas fa-chevron-left"></i></a> --}}
        </div>
    
        <h2>Left Sidebar Panel Light Layout</h2>
    </header>
                        ...
                        <header class="card-header bg-primary">
                            ...
                            <div class="widget-profile-info">
                                <div class="profile-picture">
                                    <img src="{{asset('back-end')}}/img/%21logged-user.jpg">
                                </div>
                                        ...
                                        <ul class="simple-user-list mb-3">
                                            <li>
                                                <figure class="image rounded">
                                                    <img src="{{asset('back-end')}}/img/%21sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle">
                                                </figure>
                                            ...
                                            <li>
                                                <figure class="image rounded">
                                                    <img src="{{asset('back-end')}}/img/%21sample-user.jpg" alt="Joseph Junior" class="rounded-circle">
                                                </figure>
                                            ...
                                            <li>
                                                <figure class="image rounded">
                                                    <img src="{{asset('back-end')}}/img/%21sample-user.jpg" alt="Joe Junior" class="rounded-circle">
                                                </figure>
